<script>
    ...
    import dataTableConfig from "./data-series/userRole-data-table.config.json";
...
<div class="flex flex-row justify-between p-2">
    ...
    {#if allowCreate}
        <a href="/userRole/new" class={buttonVariants({ variant: "default", size: "sm" })}>New</a>
    {/if}
</div>
                ...
                <div class="flex">
                    <InputText
                        ...
                        on:change={() => {
                            ...
                            goto(`/userRole/overview?${newParams}`, {
                                keepFocus: true
                            });
                        }} />
                    <Button
        ...
        <tr class="child:p-2 odd:bg-gray-100 hover:bg-gray-200">
            ...
            {#if allowEdit || allowDelete}
                <td class="flex items-center justify-center text-center">
                    <a
                        href="/userRole/{data?.userRoleArray[index]?.id}"
                        class="bg-tranparent hover:slate-800 border border-none border-slate-600 text-slate-600">
                        <Pencil class="h-4 w-4" /></a>
                    <form action="/userRole/{data?.userRoleArray[index]?.id}?/delete" method="POST">
