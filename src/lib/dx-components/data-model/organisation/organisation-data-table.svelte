...
<div class="flex flex-row justify-between p-2">
    ...
    {#if allowCreate}
        <a href="/organisation/new" class={buttonVariants({ variant: "default", size: "sm" })}>New</a>
    {/if}
</div>
                ...
                <div class="flex">
                    <InputText
                        ...
                        on:change={() => {
                            ...
                            goto(`/organisation/overview?${newParams}`, {
                                keepFocus: true
                            });
                        }} />
                    <Button
        ...
        <tr class="child:p-2 odd:bg-gray-100 hover:bg-gray-200">
            ...
            {#if allowEdit || allowDelete}
                <td class="flex items-center justify-center text-center">
                    <a
                        href="/organisation/{data?.organisationArray[index]?.id}"
                        class="bg-tranparent hover:slate-800 border border-none border-slate-600 text-slate-600">
                        <Pencil class="h-4 w-4" /></a>
                    <form action="/organisation/{data?.organisationArray[index]?.id}?/delete" method="POST">
