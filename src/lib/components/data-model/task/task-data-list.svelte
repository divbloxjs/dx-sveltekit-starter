<script>
    ...
    import DataListRowTask from "$lib/components/data-model/task/data-series/task-data-list-row.svelte";
...
<div class="flex w-full flex-col">
    ...
    <div class="w-full divide-y overflow-hidden rounded-lg border">
        {#each data.taskArray as taskData}
            <DataListRowTask {taskData} />
        {/each}
    </div>
